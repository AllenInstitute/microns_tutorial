...
```python
# Standard query
client.materialize.query_table('coregistration_auto_phase3_fwd_apl_vess_combined')

# Content-aware query
client.materialize.tables.coregistration_auto_phase3_fwd_apl_vess_combined(id=example_nucleus_id).query()
```

This table `coregistration_auto_phase3_fwd_apl_vess_combined` supercedes previous iterations of this table:
