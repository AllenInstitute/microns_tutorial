...
A summary of the functional properties for each of the coregistered neurons (as of `coregistration_manual_v3`). For details, see [@wang_foundation_2025] and [@ding_functional_2025].

The functional properties use the coregistration information from: `coregistration_auto_phase3_fwd_v2`.
