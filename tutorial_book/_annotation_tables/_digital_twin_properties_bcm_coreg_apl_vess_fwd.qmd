...
A summary of the functional properties for each of the coregistered neurons, using the coregistration information from: `apl_functional_coreg_vess_fwd`. For details, see [@wang_foundation_2025] and [@ding_functional_2025].
